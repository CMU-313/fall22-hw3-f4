...
public class DocumentDao {
    ...
    public DocumentDto getDocument(String id, PermType perm, List<String> targetIdList) {
        ...
        EntityManager em = ThreadLocalContext.get().getEntityManager();
        StringBuilder sb = new StringBuilder("select distinct d.DOC_ID_C, d.DOC_TITLE_C, d.DOC_DESCRIPTION_C, d.DOC_SUBJECT_C, d.DOC_IDENTIFIER_C, d.DOC_PUBLISHER_C, d.DOC_FORMAT_C, d.DOC_SOURCE_C, d.DOC_TYPE_C, d.DOC_COVERAGE_C, d.DOC_RIGHTS_C, d.DOC_SKILL_SCORE_C, d.DOC_EXP_SCORE_C, d.DOC_GPA_C, d.DOC_COMMENT_C, d.DOC_CREATEDATE_D, d.DOC_UPDATEDATE_D, d.DOC_LANGUAGE_C, ");
        ...
        documentDto.setSkillScore((String) o[i++]);
        documentDto.setExperienceScore((String) o[i++]);
        documentDto.setGPA((String) o[i++]);
        documentDto.setComment((String) o[i++]);
    ...
    public Document update(Document document, String userId) {
        ...
        documentDb.setSkillScore(document.getSkillScore());
        documentDb.setExperienceScore(document.getExperienceScore());
        documentDb.setGPA(document.getGPA());
        documentDb.setComment(document.getComment());
